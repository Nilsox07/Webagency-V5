...
| 6x | `SARTU_CORPORATE_DESIGN.md` + `design/corporate-design.html` | **die Marke** — Wortmarke, Farbregeln, Motiv, Bildsprache, E-Mail, Rechnung, Favicon | **Abbruch bei allem mit Außenwirkung.** Sonst entsteht bei jedem Dokument ein anderer Auftritt |
