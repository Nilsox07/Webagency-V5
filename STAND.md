...
| **Tests** | **345 grün**, 4281 Zusicherungen — gegen **MySQL 8.4 und** MariaDB 11.4. Kein SQLite |
| **Tabellen** | **23 von 23** |
...
| **Design** | 10.08.2026: Kunden- und Adminbereich auf die abgenommene **Seitenleiste** umgebaut, Zeichen freigegeben, Logo eingebunden. `TEXTPRUEFUNG_BEREICHE.md` |
